	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{$folder}"><img src="{$folder}/templemate/assets/images/logo.png" alt="Progressus HTML5 template"></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li><a href="{$folder}">Kalkulator</a></li>
					<li class="active"><a class="btn" href="{$folder}/index.php?action=logowanie">
						{if $user != NULL}
							Wyloguj {$user}
						{else}Logowanie{/if}
					</a></li>
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="simplenav">
								...
								<b><a href="{$folder}/index.php?action=logowanie">Logowanie</a></b>
							</p>
						</div>
					</div>
